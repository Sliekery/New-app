...
(function (ns) {
  ...
  var CLASS_ART = {
    vanguard: [
      [0,-1, 0.35,-0.7, 0.3,-0.25, 0.45,0.1, 0.3,0.95, 0.08,0.95, 0.05,0.3, -0.05,0.3, -0.08,0.95, -0.3,0.95, -0.45,0.1, -0.3,-0.25, -0.35,-0.7, 0,-1],
      [-0.22,-0.62, 0.22,-0.62],
      [0.45,0.1, 0.85,-0.35, 0.9,-0.75],
    ],
    technomancer: [
      [0,-0.9, 0.3,-0.6, 0.25,-0.2, 0.4,0.95, 0.1,0.95, 0.05,0.3, -0.05,0.3, -0.1,0.95, -0.4,0.95, -0.25,-0.2, -0.3,-0.6, 0,-0.9],
      [0,-0.9, 0,-1.2],
      [-0.1,-1.3, 0.1,-1.3, 0.1,-1.15, -0.1,-1.15, -0.1,-1.3],
      [0.25,-0.2, 0.7,-0.1, 0.8,0.35],
    ],
    voidadept: [
      [0,-1, 0.4,-0.5, 0.3,0.2, 0.45,0.95, -0.45,0.95, -0.3,0.2, -0.4,-0.5, 0,-1],
      [-0.18,-0.5, 0.18,-0.5],
      [0.4,-0.5, 0.75,-0.8],
      [0.75,-0.8, 0.75,-1.05, 0.9,-0.92, 0.75,-0.8],
    ],
  };
  ...
  function drawPlayer() {
    ...
    strokePaths(art, p.x, p.y + bob, scale, flash ? '#ff4a5e' : '#5dff88', flash ? 14 : 9, 1);
