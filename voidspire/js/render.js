...
(function (ns) {
  ...
  /* cogPath moved to js/playerart.js with the only art that used it. */
  ...
  /* ---- player avatar ----------------------------------------------------------- */
  /* The three player figures live in js/playerart.js — art belongs in a data
   * file like every other piece, not inside the renderer that draws it. */
  var CLASS_ART = ns.CLASS_ART || {};
