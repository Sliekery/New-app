...
(function (ns) {
  ...
  var CLASS_ART = {
    vanguard: {
      color: '#5dff88',
      p: [[-0.15,-0.58,-0.17,-0.74,-0.12,-0.9,0,-0.99,0.13,-0.95,0.18,-0.82,0.17,-0.66,0.1,-0.58,-0.15,-0.58], [-0.1,-0.76,0.12,-0.74,0.14,-0.63,-0.07,-0.62,-0.1,-0.76], [-0.15,-0.78,-0.02,-0.85,0.13,-0.82,0.17,-0.74], [0.17,-0.82,0.24,-0.83,0.23,-0.76,0.16,-0.77], [-0.1,-0.58,0.1,-0.58,0.12,-0.52,-0.12,-0.52,-0.1,-0.58], [-0.24,-0.54,-0.44,-0.5,-0.46,-0.32,-0.3,-0.28,-0.24,-0.4,-0.24,-0.54], [-0.3,-0.5,-0.42,-0.47,-0.42,-0.37,-0.3,-0.39,-0.3,-0.5], [0.24,-0.54,0.44,-0.5,0.46,-0.32,0.3,-0.28,0.24,-0.4,0.24,-0.54], [0.3,-0.5,0.42,-0.47,0.42,-0.37,0.3,-0.39,0.3,-0.5], [-0.24,-0.5,0.24,-0.5,0.28,-0.2,0.18,0,-0.18,0,-0.28,-0.2,-0.24,-0.5], [0,-0.46,0.08,-0.3,0,-0.12,-0.08,-0.3,0,-0.46], [-0.18,0,0.18,0,0.2,0.12,-0.2,0.12,-0.18,0], [-0.16,0.06,0.16,0.06], [-0.13,0.12,0.13,0.12,0.11,0.22,-0.11,0.22,-0.13,0.12], [-0.2,0.12,-0.28,0.3,-0.26,0.48,-0.1,0.5,-0.06,0.3,-0.06,0.14,-0.2,0.12], [NaN,0.42,NaN,0.42,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,-0.15,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,0.3,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,-0.25,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,NaN,0.42], [0.2,0.12,0.28,0.3,0.26,0.48,0.1,0.5,0.06,0.3,0.06,0.14,0.2,0.12], [-0.2,0.48,-0.07,0.5,-0.07,0.58,-0.2,0.56,-0.2,0.48], [0.2,0.48,0.07,0.5,0.07,0.58,0.2,0.56,0.2,0.48], [-0.18,0.56,-0.2,0.78,-0.13,0.86,-0.06,0.84,-0.06,0.58,-0.18,0.56], [0.18,0.56,0.2,0.78,0.13,0.86,0.06,0.84,0.06,0.58,0.18,0.56], [-0.16,0.84,-0.22,0.95,-0.04,0.96,-0.05,0.84,-0.16,0.84], [0.16,0.84,0.22,0.95,0.04,0.96,0.05,0.84,0.16,0.84], [-0.24,-0.46,-0.4,-0.44,-0.5,-0.3,-0.52,-0.18,-0.43,-0.14,-0.4,-0.28,-0.28,-0.36,-0.24,-0.46], [-0.5,-0.3,-0.58,-0.32,-0.6,-0.2,-0.52,-0.16,-0.5,-0.3], [-0.45,-0.36,-0.62,-0.42,-0.64,-0.34,-0.47,-0.28,-0.45,-0.36], [-0.52,-0.36,-0.86,-0.86,-0.93,-0.81,-0.58,-0.31,-0.52,-0.36], [-0.55,-0.36,-0.88,-0.83]],
  ...
  function drawPlayer() {
    ...
    if (atk && atk.type === 'aim') {                 // vanguard: snap to aim, FIRE with recoil, recover
      var ang = 0, firing = false;
      if (atking) {
        if (aprog < 0.34) ang = ease(aprog / 0.34) * atk.aim;                     // snap the muzzle down onto target
        ...
        else ang = atk.aim * (1 - ease((aprog - 0.58) / 0.42));                    // lower the weapon back to rest
      }
