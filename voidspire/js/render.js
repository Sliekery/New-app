...
(function (ns) {
  ...
  var POWER_CAT = {
    ...
    plate: 'def', platedArmor: 'def', feelNoPain: 'def', afterImage: 'def', barricade: 'def', retain: 'def', thorns: 'def', regen: 'def',
    turret: 'sp', echo: 'sp', reactor: 'sp', darkEmbrace: 'sp', corruption: 'sp', bloodPact: 'sp',
  };
