...
(function (ns) {
  ...
  ns.EVENTS = [
    ...
    },
    {
      ...
      choices: [
        { label: 'Trade it a weapon', sub: 'Feed it one card → it builds you a better one',
          outcome: { text: 'The drone scans your kit, chirps approval, and breaks one of your weapons down to forge something keener.', fx: { tradeCard: true } } },
    ...
    },
    {
      ...
      choices: [
        ...
        { label: 'Trade it data', sub: 'Feed it a card to study → get a sharper one back',
          outcome: { text: '“FASCINATING DESIGN. I CAN DO BETTER.” It melts your schematic down and prints an improved variant.', fx: { tradeCard: true } } },
    ...
    },
    {
      ...
      choices: [
        { label: 'Feed it a weapon', sub: 'Sacrifice one card → it forges a stronger one',
          outcome: { text: 'The mechadendrite snatches a weapon from your kit, plunges it into the crucible, and hammers out something meaner.', fx: { tradeCard: true } } },
