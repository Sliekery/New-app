...
(function (ns) {
  ...
  ns.ARTIFACTS = {
    ...
    recoilless_frame: { name: 'Recoilless Frame', tier: 1, rarity: 'class', cls: 'vanguard', questOnly: true,
    ...
    execution_protocol: { name: 'Execution Protocol', tier: 1, rarity: 'class', cls: 'vanguard', questOnly: true, k: 'executeBonus', v: 1,
    ...
    forge_reserve: { name: 'Forge Reserve', tier: 1, rarity: 'class', cls: 'technomancer', questOnly: true, k: 'blockStartTechMul', v: 3,
    ...
    capacitive_plating: { name: 'Capacitive Plating', tier: 1, rarity: 'class', cls: 'technomancer', questOnly: true, k: 'shieldPingPct', v: 34,
    ...
    hexweaver: { name: 'Hexweaver', tier: 1, rarity: 'class', cls: 'voidadept', questOnly: true, k: 'hexweaver', v: 2,
