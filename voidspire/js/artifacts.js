...
(function (ns) {
  ...
  ns.ARTIFACTS = {
    ...
    warlord_doctrine: { name: 'Warlord Doctrine', tier: 2, cls: 'vanguard', k: 'strStart', v: 3, desc: 'Start each combat with 3 Might.',
    ...
    recoilless_frame: { unlock: { track: 'kills', goal: 8, label: 'Kill 8 enemies' }, name: 'Recoilless Frame', tier: 1, rarity: 'class', cls: 'vanguard', questOnly: true,
    ...
    execution_protocol: { unlock: { track: 'turnDamage', goal: 60, atOnce: true, label: 'Deal 60 damage in one turn' }, name: 'Execution Protocol', tier: 1, rarity: 'class', cls: 'vanguard', questOnly: true, k: 'executeBonus', v: 1,
      desc: 'Your attacks deal double damage to enemies below 25% HP.',
      art: { p: [[0,-0.7, 0,0.7], [-0.45,-0.45, 0,-0.7, 0.45,-0.45], [-0.3,0.3, 0.3,0.3], [-0.45,0.55, 0.45,0.55]], e: [[0,0]] } },
    forge_reserve: { unlock: { track: 'shieldGained', goal: 80, label: 'Gain 80 Shield' }, name: 'Forge Reserve', tier: 1, rarity: 'class', cls: 'technomancer', questOnly: true, k: 'blockStartTechMul', v: 3,
    ...
    capacitive_plating: { unlock: { track: 'shieldAtOnce', goal: 35, atOnce: true, label: 'Hold 35 Shield at once' }, name: 'Capacitive Plating', tier: 1, rarity: 'class', cls: 'technomancer', questOnly: true, k: 'shieldPingPct', v: 34,
    ...
    hexweaver: { unlock: { track: 'burnApplied', goal: 40, label: 'Apply 40 Burn' }, name: 'Hexweaver', tier: 1, rarity: 'class', cls: 'voidadept', questOnly: true, k: 'hexweaver', v: 2,
    ...
    void_conduit: { unlock: { track: 'burnAtOnce', goal: 12, atOnce: true, label: 'Stack 12 Burn on one enemy' }, name: 'Void Conduit', tier: 1, rarity: 'class', cls: 'voidadept', questOnly: true, k: 'firstPowerFree', v: 1,
