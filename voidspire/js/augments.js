...
(function (ns) {
  ...
  ns.AUGMENTS = {
    ...
    honed_edge:   { name: 'Honed Edge', rarity: 1, cls: 'any', kind: 'hook', hook: { k: 'flatDmg', v: 2 },
      desc: 'Your attacks deal +2 damage.' },
    armor_weave:  { name: 'Armor Weave', rarity: 1, cls: 'any', kind: 'hook', hook: { k: 'plate', v: 2 },
      desc: 'Gain 2 Shield at the start of each turn.' },
